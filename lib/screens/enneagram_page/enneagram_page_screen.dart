            ...
            child: Column(
              children: <Widget>[
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text("에니어그램이란?", style: CustomTextStyles.buildTextStyle(fontSize: 25)),
                      Text("애니어그램은 9가지 유형으로 이루어진 성격 테스트입니다. 어떤 유형들이 있는지 알아보아요.", style: CustomTextStyles.buildTextStyle(fontSize: 18),),
                    ],
                  ),
                ),
    ...
    return Container(
          ...
          decoration: BoxDecoration(
            /*image: DecorationImage(
              image: AssetImage("assets/images/background/snowman-1090261.jpg"),
              fit: BoxFit.fill,
            ),*/
        ...
        child: TextButton(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 3),
              Text(
                enneagramTypeList[enneagramType]!.subName,
