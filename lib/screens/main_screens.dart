...
class MainScreens extends StatefulWidget {
  const MainScreens({Key? key, this.myEnneagramTest}) : super(key: key);
...
class _MainScreensState extends State<MainScreens> {
  late final EnneagramTest? myEnneagramTest;
  ...
  @override
  void initState() {
    myEnneagramTest = widget.myEnneagramTest;
    _isInit = initMainState();
    super.initState();
  }
