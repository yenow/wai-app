...
const darkBlueGrey = Color.fromRGBO(75, 109, 116, 1.0);
const blueGrey = Colors.blueGrey;
const lightBlueGrey2 = Color.fromRGBO(124, 153, 172,1);
...
const buttonTextColor = Color.fromRGBO(60, 60, 100, 1);
const buttonLabelColor = Color.fromRGBO(160, 160, 160, 1);
const buttonFloatingColor = Color.fromRGBO(100, 100, 100, 1);


const temp = Color.fromRGBO(77, 106, 113, 1.0);
