        ...
        children: [
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                ...
                const Blank(width: 5,),
                Text('${post.author!} [${post.authorEnneagramType!}유형]', style: const TextStyle(fontSize: 18, color: WaiColors.white60)),
              ],
            ),
          ),
          ...
          Expanded(
            child: Padding(
              ...
              child: Text(post.content!, style: const TextStyle(fontSize: 20, color: WaiColors.white80)),
            )
          ),
        ],
      ),
